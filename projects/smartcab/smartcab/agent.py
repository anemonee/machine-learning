...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=1.0, alpha=0.5, count = 1):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon = self.epsilon* math.pow(a,self.count)
            self.epsilon = math.exp(-1 * a * self.count)
    ...
    def update(self):
    #The update function is called when a time step is completed in the environment for a given trial. This function will build the agent state, choose an action, receive a reward, and learn if enabled. """
